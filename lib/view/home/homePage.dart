...
import 'package:chevaldetroie/view/horsenrider.dart';
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  TextButton(
                      onPressed: () {Navigator.push(context, MaterialPageRoute(builder: (context) => HorseNRider()));}, child: const Text("Cavalier/Cheval"))
                ],
              ),
            ),
            ListView.builder(
